...
INSERT INTO `CT_Score` (`id`, `title`, `isFlagged`, `isPublic`, `genre`, `composer`, `composeYear`, `publishYear`, `instrumentation`, `description`, `downloadLink`, `downloads`, `likes`, `likeList`, `timestamp`, `uploadedBy`, `language`, `opusNum`, `key`, `style`) VALUES
(1, 'Suite for String Orchestra, Op.63', 0, 1, 'Suites, For strings, Scores featuring string ensemble', 'Arthur P. Schmidt', 1909, 1909, 'violins, violas, cellos, bass', '3 movments Praeludium. Pizzicato and Adagietto. Fuge', 'assets/scores/sample.jpg', 5, 3, '', 20130211, 1, 'German', 'Op.63', '12', 1),
(2, 'Caazapa (Barrios Mangore, Agustin)', 1, 1, '0', 'Barrios Mangore, Agustin', 1952, 1979, 'Guitar', '4 pieces: Primavera Junto a tu corazon in D minor in G major', 'assets/scores/sample.jpg', 12, 3, '', 20130301, 15, 'English', 'Op.8', '2', 1),
(3, 'Au Clair de la Lune, chante dans Les Voitures Versees, varie, Op.7', 0, 1, 'Variations For guitar', 'Carcassi, Matteo', 1823, 1827, 'guitar', 'Anvers: A. Schott, n.d., plate 2555', 'assets/scores/sample.jpg', 32, 2, '', 20130315, 13, 'German', 'Op.7', '2', 2);
